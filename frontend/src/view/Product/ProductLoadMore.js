        ...
        <aside className="w-80 flex-shrink-0 absolute left-12 top-[120px] bg-white shadow-lg rounded-r-lg p-6 z-30">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center justify-between mb-3 text-sm">
              <span className="text-blue-600 font-medium">{priceRange[0].toLocaleString()} VND</span>
          ...
          {/* Sắp xếp */}
          <div className="mb-6">
            <label className="text-sm font-semibold text-gray-700 mb-2 block">Sắp Xếp</label>
            <select
              value={sortOrder}
